...
```{js simpleJS, exercise=TRUE,  exercise.timelimit = 2, exercise.eval=TRUE, exercise.cap = "app.js", exercise.id="firstJSExercise", exercise.type = "js", exercise.libraryPath = "/home/libraries"} 
...
```{js express1,exercise=TRUE, exercise.id = "expressExercise", exercise.timelimit = 10, exercise.type = "js", exercise.lines = 20, exercise.cap = "app.js", exercise.eval = FALSE, exercise.serverIP = "#JOBE_SERVER_IP#"}  
